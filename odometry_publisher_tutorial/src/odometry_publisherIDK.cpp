//***Save this as odometry.cpp***// THIS IS THE ORIGINAL!!
#include "ros/ros.h"
...
double DistancePerCount = (3.14159265 * 0.0287)/2000; //the wheel diameter is 0.1m
...
void WheelCallback(const geometry_msgs::Vector3::ConstPtr& ticks)
{
 ...
 delta_th = (double)(deltaRight-deltaLeft)*DistancePerCount/0.6985; //Distance between the two wheels is 0.36m 0.586 0.732    //0.67   0.68
